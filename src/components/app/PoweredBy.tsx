...
export const PoweredBy: React.FC = () => (
  <div className={cn('flex flex-col mb-4 mt-2')}>
    <ExternalLink
      href="https://github.com/flodlc/nebula"
      className={cn(
        'mx-auto mb-2 font-["Bowlby_One_SC"]',
        'bg-clip-text text-transparent bg-[linear-gradient(-324deg,#00ffea,#209bff)]'
      )}>
      Nebula
    </ExternalLink>
...
const VercelLogo: React.FC<React.SVGAttributes<SVGAElement>> = (props) => (
  <svg
...
const NextJsLogo: React.FC<React.SVGAttributes<SVGAElement>> = (props) => (
  <svg
    aria-label="Next.js"
    height="35"
    version="1.1"
...
const TailwindLogo: React.FC<React.SVGAttributes<SVGAElement>> = (props) => (
  <svg
